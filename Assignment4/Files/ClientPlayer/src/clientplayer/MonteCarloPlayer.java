...
public class MonteCarloPlayer implements Player
{
    ...
    public String MakeMove(String board)
    {
        ...
        Position pos = doMonteCarlo(temp, availableSlots);

        return pos.toString();
    }

    private Position doMonteCarlo(BoardDataStructure board, ArrayList<Position> slots){
        ...
        return Side == BoardDataStructure.RedMove ? slots.get(0) : slots.get(slots.size()-1);
    }
